...
if studyArea == 'wlera':
    base_path = 'C:/Workspace/IndexTest/Data/WLERA_Raster_Data/WLERA_'

elif studyArea == 'crsra':
    base_path = 'C:/Workspace/IndexTest/Data/CRSRA_Raster_Data/CRSRA_'

elif studyArea == 'sbra':
    base_path = 'C:/Workspace/IndexTest/Data/SBRA_Raster_Data/SBRA_'
